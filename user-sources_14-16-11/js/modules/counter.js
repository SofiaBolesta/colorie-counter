...
export default class Counter {
    constructor(element) {
        ...
        this.paarameters = this.elements.paramets.elements;
        ...
        this.parametrsItems = Array.from(this.parametrs);
    ...
    _onFormInput() {
        ...
        this.reset.disables = !this.parametersItems.some((el) => el.value);
    ...
    getCaloriesNorm() {
        ...
        const activity = PhysicaAcrivityRatio[this.activity.value.toUpperCase()];
